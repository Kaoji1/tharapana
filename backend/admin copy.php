...
$menuManagement = [
  'manage_room_types'      => ['file' => 'manage_room_types.php', 'label' => 'ข้อมูลห้องพัก', 'icon' => 'bi-door-open-fill'],
  'admin_calendar'   => ['file' => 'admin_calendar.php', 'label' => 'การจอง', 'icon' => 'bi-calendar-check-fill'],
...
$menuSystem = [
  'manage_receipts'   => ['file' => 'manage_receipts.php', 'label' => 'จัดการใบเสร็จ (E-Receipt)', 'icon' => 'bi-receipt-cutoff'],
  'manage_admins'      => ['file' => 'manage_admins.php', 'label' => 'จัดการแอดมิน', 'icon' => 'bi-person-lock'],
  'manage_reports'    => ['file' => 'manage_reports.php', 'label' => 'รายงานและสถิติ', 'icon' => 'bi-file-earmark-bar-graph-fill'],
...
$allowedPages = $menuDashboard + $menuManagement + $menuMarketing + $menuSystem;
    ...
    <main class="content">
      ...
      <div class="page-content">
        ...
        if (isset($allowedPages[$current])) {
          ...
          // ถ้าเรียกหน้าที่ไม่มีอยู่จริง ให้กลับไปที่ dashboard
          header('Location: admin.php?page=dashboard');
          exit;
        }
        ?>
